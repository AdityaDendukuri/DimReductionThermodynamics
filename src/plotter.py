...
def plot_2d(x, y, x_label="x", y_label="y", color = []):
...
def plot_3d(x, y, z, x_label="x", y_label="y",z_label="z",color = []):
      fig = plt.figure(figsize=(10, 8))
...
def plot_space(coordinates, color):
      coordinates = np.reshape(coordinates, [len(coordinates), int(len(coordinates)/3), 3])
      plot_3d(coordinates[:, :, 0], coordinates[:, :, 1], coordinates[:, :, 2], color=color)
...
def plot_new_space_3d( eigvals, eigvecs, potentials):
    ...
    idx1 = index(eigvals, temp[1])
    idx2 = index(eigvals, temp[2])
    idx3 = index(eigvals, temp[3])
    x_plt = []
    y_plt = []
    z_plt = []
